...
public class HomeFragment extends Fragment {
    ...
    public ArrayList<Picture> buildPictures (){
        ...
        pictures.add(new Picture("https://cdn.hispantv.com/hispanmedia/files/images/thumbnail/20180108/09101417_xl.jpg", "Programacion Web","4 dias","5","Ejemplo de descripcion del curso actual"));
        pictures.add(new Picture("https://dev-res.thumbr.io/libraries/45/01/lib/1370151995235.jpg?size=854x493s&ext=jpg", "Introduccion a programacion","8 dias","2","Ejemplo de descripcion del curso actual"));
